      ...
      <div className="flex mt-1">
        {traded.map((d) => (
          <div key={d.day} className="flex-1 text-center">
            ...
            <div className="pd-mono" style={{ fontSize: 9, color: "var(--slate)" }}>{d.n}</div>
          </div>
        ))}
      </div>
    </div>
